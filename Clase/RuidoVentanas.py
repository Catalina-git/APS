...
N_fft = 2**14 # FFT larga para buena resolución espectral
...
plt.plot(freq, respuesta_BH,color="red", label = 'Blackman Harris')
plt.plot(freq, respuesta_Hamming, color="lime", label = 'Hamming')
plt.plot(freq, respuesta_Hann, color="yellow", label = 'Hann')
plt.plot(freq, respuesta_Rectangular,  color='dodgerblue', label = 'Rectangular')
plt.plot(freq, respuesta_FT, color="brown",  label = 'Flattop')
